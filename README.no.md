...
# Pakkehåndterere
npm i -g oc2-ai@latest        # eller bun/pnpm/yarn
...
OC2 er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/panwar-stack/oc2/releases) eller [oc2.ai/download](https://oc2.ai/download).
