...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at oc2.ai",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.oc2/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.oc2/plugins/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent OC2 from reading sensitive files",
  ...
  "Use {highlight}/oc2{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}oc2 github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/oc2 fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/panwar-stack/oc2{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with OC2 Zen for curated, tested models",
