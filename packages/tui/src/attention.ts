...
import defaultSoundPath from "@oc2-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@oc2-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@oc2-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@oc2-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@oc2-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@oc2-ai/ui/audio/yup-01.mp3" with { type: "file" }
