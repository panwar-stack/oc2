...
declare const OC2_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof OC2_LIBC === "undefined" ? undefined : OC2_LIBC
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.OC2_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.OC2_EXPERIMENTAL_FILEWATCHER) {
