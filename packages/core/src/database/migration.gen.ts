...
export const migrations = (
  await Promise.all([
    ...
    import("./migration/20260511180000_session_processing"),
    import("./migration/20260511181000_session_root"),
    import("./migration/20260511182000_team_tables"),
    import("./migration/20260511183000_repository_memory_tables"),
    ...
    import("./migration/20260718001000_add_team_board_semantics"),
    import("./migration/20260718002000_session_input_activity"),
  ])
