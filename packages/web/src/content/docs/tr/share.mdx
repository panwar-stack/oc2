---
title: Paylasim
description: oc2 konusmalarini genel baglantilarla paylasin.
---

oc2'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda oc2:
...
oc2, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak oc2 manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `oc2.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda oc2 kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
