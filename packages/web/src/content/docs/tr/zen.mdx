---
title: Zen
description: oc2 tarafından sağlanan seçilmiş modeller listesi.
---
...
OC2 Zen, OC2 ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, OC2'daki diğer sağlayıcılar gibi çalışır. OC2 Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve OC2 kullanmak için buna ihtiyacınız yoktur.
...
:::tip
OC2 ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
OC2 Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

OC2 Zen, OC2'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>OC2 Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, OC2 Zen'i seçin ve API anahtarınızı yapıştırın.
...
OC2 yapılandırmanızdaki [model id](/docs/config/#models) `oc2/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `oc2/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için OC2'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için OC2'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için OC2'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için OC2'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
OC2 Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca OC2 ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
