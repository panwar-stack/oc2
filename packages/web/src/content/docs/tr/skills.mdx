...
Ajan becerileri, oc2'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
oc2 su konumlari tarar:

- Proje konfigurasyonu: `.oc2/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/oc2/skills/<name>/SKILL.md`
...
Proje yerel yollarinda oc2, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.oc2/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/oc2/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.oc2/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
oc2, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`oc2.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`oc2.json` icinde):
