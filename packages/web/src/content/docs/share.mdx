---
title: Share
description: Share your OC2 conversations.
---

OC2's share feature allows you to create public links to your OC2 conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, OC2:
...
OC2 supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, OC2 uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `oc2.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using oc2 in your organization.
