---
title: TUI
description: Usando a interface de usuário de terminal oc2.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O oc2 fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar oc2 inicia o TUI para o diretório atual.
...
Ao usar o TUI do oc2, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao oc2. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Isso é separado do `oc2.json`, que configura o comportamento do servidor/runtime.
...
- `leader_timeout` - Controla por quanto tempo o OC2 espera depois da leader key. O padrão é `2000`.
...
- `sound_pack` - ID do sound pack a ser usado. O padrão é `oc2.default`.
