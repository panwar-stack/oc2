...
description: Crie ferramentas que o LLM pode chamar no oc2.
---

Ferramentas personalizadas são funções que você cria e que o LLM pode chamar durante as conversas. Elas funcionam junto com as [ferramentas integradas](/docs/tools) do oc2, como `read`, `write` e `bash`.
...
- Localmente, colocando-as no diretório `.oc2/tools/` do seu projeto.
- Ou globalmente, colocando-as em `~/.config/oc2/tools/`.
