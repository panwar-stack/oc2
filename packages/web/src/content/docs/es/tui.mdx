---
title: TUI
description: Usando la interfaz de usuario del terminal OC2.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OC2 proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar OC2 se inicia TUI para el directorio actual.
...
Cuando utilice OC2 TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a OC2. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Esto es independiente de `oc2.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera OC2 después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `oc2.default`.
