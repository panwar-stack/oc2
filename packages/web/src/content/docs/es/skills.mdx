...
Las habilidades del agente permiten a OC2 descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
OC2 busca estas ubicaciones:

- Configuración del proyecto: `.oc2/skills/<name>/SKILL.md`
- Configuración global: `~/.config/oc2/skills/<name>/SKILL.md`
...
Para las rutas locales del proyecto, OC2 sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
Carga cualquier `skills/*/SKILL.md` coincidente en `.oc2/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/oc2/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.oc2/skills/git-release/SKILL.md` así:
...
OC2 enumera las habilidades disponibles en la descripción de la herramienta `skill`.
...
Controle a qué agentes de habilidades pueden acceder utilizando permisos basados ​​en patrones en `oc2.json`:
...
**Para agentes integrados** (en `oc2.json`):
