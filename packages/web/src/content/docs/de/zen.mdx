---
title: Zen
description: Kuratierte Modellliste direkt von OC2.
---
...
OC2 Zen ist eine Liste von getesteten und verifizierten Modellen, die vom OC2-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in OC2. Du meldest dich bei OC2 Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um OC2 zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit OC2 funktionieren.
:::
...
OC2 Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

OC2 Zen funktioniert wie jeder andere Provider in OC2.

1. Du meldest dich bei **<a href={console}>OC2 Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst OC2 Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner OC2-Konfiguration verwendet das Format `oc2/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `oc2/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf OC2 verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf OC2 verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf OC2 verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf OC2 verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben OC2 Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit OC2 auch jeden anderen Provider zu verwenden.
