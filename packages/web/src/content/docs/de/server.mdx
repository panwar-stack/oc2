---
title: Server
description: Nutze den oc2-Server ueber HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Der Befehl `oc2 serve` startet einen headless HTTP-Server.
Er stellt einen OpenAPI-Endpunkt bereit, den ein oc2-Client nutzen kann.
...
Setze `OC2_SERVER_PASSWORD`, um den Server mit HTTP Basic Auth zu schuetzen.
Der Benutzername ist standardmaessig `oc2`, kann aber mit `OC2_SERVER_USERNAME` ueberschrieben werden. Das gilt fuer `oc2 serve` und `oc2 web`.
...
Wenn du `oc2` startest, werden TUI und Server gestartet.
...
:::tip
Nutze den oc2-Server, um oc2 programmatisch anzusteuern.
:::

Diese Architektur erlaubt mehrere Clients und programmatische Nutzung.

Mit `oc2 serve` startest du einen eigenstaendigen Server.
Laeuft bereits eine TUI, startet `oc2 serve` trotzdem eine neue Serverinstanz.
...
Dieses Muster nutzen auch die OC2-[IDE](/docs/ide)-Plugins.
...
Der oc2-Server stellt folgende APIs bereit.
