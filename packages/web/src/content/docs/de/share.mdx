---
title: Teilen
description: Teile OC2-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu OC2-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht OC2 Folgendes:
...
OC2 hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt OC2 den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`oc2.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du oc2 in deiner Organisation einsetzt.
