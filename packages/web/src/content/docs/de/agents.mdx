...
Es gibt zwei Arten von Agenten in OC2; Primäragenten und Subagenten.
...
OC2 verfügt über zwei integrierte Primäragenten: **Build** und **Plan**. Auch
...
Konfigurieren Sie Agenten in Ihrer `oc2.json`-Konfigurationsdatei:
...
Wenn keine Temperatur angegeben ist, verwendet OC2 modellspezifische Standardwerte; typischerweise 0 für die meisten Modelle, 0.55 für Qwen-Modelle.
...
Dieser Pfad ist relativ zum Speicherort der Konfigurationsdatei. Dies funktioniert sowohl für die globale OC2-Konfiguration als auch für die projektspezifische Konfiguration.
...
Die Modell-ID in Ihrer OC2-Konfiguration verwendet das Format `provider/model-id`. Wenn Sie beispielsweise [OC2 Zen](/docs/zen) verwenden, würden Sie `oc2/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
...
:::tip
Führen Sie `oc2 models` aus, um eine Liste der verfügbaren Modelle anzubieten.
:::
...
:::tip
Haben Sie einen Agenten, den Sie gerne teilen möchten? [Reichen Sie einen PR ein](https://github.com/panwar-stack/oc2).
:::
