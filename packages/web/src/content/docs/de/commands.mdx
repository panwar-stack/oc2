...
Erstellen Sie `.oc2/commands/test.md`:
...
Sie können benutzerdefinierte Befehle über die OC2-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem OC2 [config](/docs/config):
...
OC2 enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
