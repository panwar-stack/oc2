---
title: SDK
description: Client JS de type sécurisé pour le serveur oc2.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Le SDK oc2 JS/TS fournit un client de type sécurisé pour interagir avec le serveur.
Utilisez-le pour créer des intégrations et contrôler oc2 par programme.
...
Vous pouvez transmettre un objet de configuration pour personnaliser le comportement. L'instance récupère toujours votre `oc2.json`, mais vous pouvez remplacer ou ajouter une configuration en ligne :
...
Si vous disposez déjà d'une instance en cours d'exécution de oc2, vous pouvez créer une instance client pour vous y connecter :
