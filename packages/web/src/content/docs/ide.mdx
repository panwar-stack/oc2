---
title: IDE
description: The OC2 extension for VS Code, Cursor, and other IDEs
---

OC2 integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `oc2` in the terminal to get started.
...
To install OC2 on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `oc2` - the extension installs automatically
...
Search for **OC2** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `oc2` in the integrated terminal.
