...
description: Lag verktøy som LLM kan kalle inn OC2.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med OC2 sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.oc2/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/oc2/tools/`.
