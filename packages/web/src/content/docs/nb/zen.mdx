---
title: Zen
description: Utvalgt liste over modeller levert av OC2.
---
...
OC2 Zen er en liste over testede og verifiserte modeller levert av OC2-teamet.

Zen fungerer som enhver annen leverandør i OC2. Du logger inn på OC2 Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med OC2.
:::
...
OC2 Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

OC2 Zen fungerer som enhver annen leverandør i OC2.

1. Du logger inn på **<a href={console}>OC2 Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger OC2 Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i OC2-konfigurasjonen din
bruker formatet `oc2/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `oc2/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på OC2 i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på OC2 i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på OC2 i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på OC2 i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med OC2 også.
