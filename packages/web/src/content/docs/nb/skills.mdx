...
Agentferdigheter lar OC2 oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
oc2 søker etter disse stedene:

- Prosjektkonfigurasjon: `.oc2/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/oc2/skills/<name>/SKILL.md`
...
For prosjektlokale stier går oc2 opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.oc2/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/oc2/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.oc2/skills/git-release/SKILL.md` slik:
...
oc2 viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `oc2.json`:
...
**For innebygde agenter** (i `oc2.json`):
