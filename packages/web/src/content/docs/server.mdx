...
| `GET`    | `/session/:sessionID/supervisor`         | Get supervisor state                  | Returns <a href={typesV2Url}><code>SupervisorState</code></a>                      |
| `PATCH`  | `/session/:sessionID/supervisor`         | Update session supervisor settings    | body: <a href={typesV2Url}><code>SupervisorSettingsPatch</code></a>, returns <a href={typesV2Url}><code>SupervisorState</code></a> |
| `GET`    | `/session/:sessionID/supervisor/report`  | Get supervisor report                 | Returns <a href={typesV2Url}><code>SupervisorReport</code></a>                     |
...
Supervisor events are included when supervision is enabled or per-session settings change: `supervisor.state.updated`, `supervisor.recommendation.created`, `supervisor.settings.updated`, and `supervisor.report.completed`.
