...
Možete dodati prilagođene komande kroz OC2 konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom OC2 [config](/docs/config):
...
- Globalno: `~/.config/oc2/commands/`
- Po projektu: `.oc2/commands/`
...
OC2 uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
