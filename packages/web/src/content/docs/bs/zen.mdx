---
title: Zen
description: Kurirana lista modela koje nudi OC2.
---
...
OC2 Zen je lista testiranih i provjerenih modela koje pruža OC2 tim.

Zen radi kao i svaki drugi provajder u OC2. Prijavite se na OC2 Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili OC2.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s OC2.
:::
...
OC2 Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

OC2 Zen radi kao i svaki drugi provajder u OC2.

1. Prijavite se na **<a href={console}>OC2 Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite OC2 Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj OC2 konfiguraciji koristi format
`oc2/<model-id>`. Na primjer, za GPT 5.5 u konfiguraciji biste
koristili `oc2/gpt-5.5`.
...
- DeepSeek V4 Flash Free je dostupan na OC2 ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo-V2.5 Free je dostupan na OC2 ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Ultra Free je dostupan na OC2 ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na OC2 ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u OC2.
