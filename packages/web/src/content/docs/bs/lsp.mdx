---
title: LSP serveri
description: OC2 se integriše sa vašim LSP serverima.
---

OC2 se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

OC2 dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `OC2_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i oc2 otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj oc2 konfiguraciji.
