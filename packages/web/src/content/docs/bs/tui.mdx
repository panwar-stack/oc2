---
title: TUI
description: Korištenje korisničkog interfejsa OC2 terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OC2 pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje OC2 pokreće TUI za trenutni direktorij.
...
Kada koristite OC2 TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u OC2. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz OC2. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `oc2.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo OC2 čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `oc2.default`.
