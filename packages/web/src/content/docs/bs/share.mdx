---
title: Dijeljenje
description: Dijelite OC2 razgovore javnim linkovima.
---

OC2 opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
OC2 podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, OC2 koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `oc2.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju oc2 u organizaciji.
