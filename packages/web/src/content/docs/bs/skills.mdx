...
Agent skills omogucavaju OC2 da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
OC2 pretrazuje ove lokacije:

- Konfiguracija projekta: `.oc2/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/oc2/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, OC2 ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.oc2/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/oc2/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.oc2/skills/git-release/SKILL.md` ovako:
...
OC2 navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `oc2.json`:
