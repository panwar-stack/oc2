...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ OC2:
...
- ระดับผู้ใช้ (Global): `~/.config/oc2/commands/`
- ระดับโปรเจ็กต์: `.oc2/commands/`
...
OC2 มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
