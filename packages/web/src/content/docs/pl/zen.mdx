---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez OC2.
---
...
OC2 Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół OC2.

Zen działa jak każdy inny dostawca w OC2. Zaloguj się do OC2 Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z OC2.
:::
...
OC2 Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

OC2 Zen działa jak każdy inny dostawca w OC2.

1. Zaloguj się do **<a href={console}>OC2 Zen</a>**, dodaj dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz OC2 Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji OC2 używa formatu
`oc2/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`oc2/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w OC2 przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w OC2 przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w OC2 przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w OC2 przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w OC2 także dowolnego innego dostawcy.
