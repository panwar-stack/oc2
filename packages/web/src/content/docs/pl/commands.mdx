...
Możesz zdefiniować polecenia w `oc2.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji oc2:
...
- Globalnie: `~/.config/oc2/commands/`
- Na projekt: `.oc2/commands/`
...
oc2 zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
