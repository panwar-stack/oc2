---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala oc2.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

oc2 zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie oc2 uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI oc2, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do oc2. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `oc2.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo OC2 czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `oc2.default`.
