...
:::note
The `local_fusion` tool uses inline branch, judge, and synthesizer settings in the tool input. Named compound config entries are not part of `opencode.json` yet.
:::
