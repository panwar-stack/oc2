...
Branches and the judge are research stages. If Logu grants write-capable policies to a branch or judge, those writes are isolated to a temporary scratch directory. Only the synthesizer should apply final edits to workspace files.
