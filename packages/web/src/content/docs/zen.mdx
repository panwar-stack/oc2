---
title: Zen
description: Curated list of models provided by OC2.
---
...
OC2 Zen is a list of tested and verified models provided by the OC2 team.

Zen works like any other provider in OC2. You login to OC2 Zen and get
...
:::tip
We tested a select group of models and providers that work well with OC2.
:::
...
OC2 Zen is an AI gateway that gives you access to these models.

---

## How it works

OC2 Zen works like any other provider in OC2.

1. You sign in to **<a href={console}>OC2 Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select OC2 Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your OC2 config
uses the format `oc2/<model-id>`. For example, for GPT 5.5, you would
use `oc2/gpt-5.5` in your config.
...
- DeepSeek V4 Flash Free is available on OC2 for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on OC2 for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on OC2 for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on OC2 for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with OC2 as well.
