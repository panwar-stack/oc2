      ...
      "branches": [
        {
          ...
          "prompt": "Focus on implementation risks."
        },
        {
          "model": "openai/gpt-5",
          "prompt": "Focus on product behavior and edge cases."
        }
      ],
...
```bash frame="none"
/local_fusion research-panel Compare the safest rollout plan for this API migration.
```

The slash command asks the model to call the `local_fusion` tool with `config: "research-panel"` and your prompt.
