...
- Judge and synthesizer receive no tools.
...
:::caution
`local_fusion` does not provide `model: "compound/..."` routing, branch trace UI, crash recovery records, or mutating branch tools in this version.
:::
