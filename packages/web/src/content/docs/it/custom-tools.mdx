...
description: Crea strumenti che l'LLM puo chiamare in oc2.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di oc2 come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.oc2/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/oc2/tools/`.
