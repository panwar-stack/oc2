---
title: Condivisione
description: Condividi le tue conversazioni OC2.
---

La funzione di condivisione di OC2 ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, OC2:
...
OC2 supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, OC2 usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `oc2.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare oc2 nella tua organizzazione.
