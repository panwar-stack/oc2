...
Puoi aggiungere comandi personalizzati tramite la config di OC2 o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di OC2:
...
- Globale: `~/.config/oc2/commands/`
- Per progetto: `.oc2/commands/`
...
oc2 include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
