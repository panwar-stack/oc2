...
description: Opret værktøjer, som LLM kan kalde oc2 ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med OC2's [indbyggede værktøjer](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.oc2/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/oc2/tools/`.
