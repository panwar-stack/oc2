---
title: LSP-servere
description: OC2 integreres med dine LSP-servere.
---

OC2 kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

OC2 leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `OC2_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og oc2 åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din oc2-konfiguration.
