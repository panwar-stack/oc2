...
Agentferdigheter lar OC2 oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går OC2 opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
OC2 viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `oc2.json`:
