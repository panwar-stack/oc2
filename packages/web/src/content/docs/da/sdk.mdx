...
Brug den til at bygge integrasjoner og kontrollere oc2 programmatisk.
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `oc2.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av oc2, kan du oprete en klientforekomst for at koble til den:
