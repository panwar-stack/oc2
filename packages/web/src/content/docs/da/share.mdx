---
title: Deling
description: Del dine OC2-samtaler.
---

OC2s delingsfunksjon lar deg lage offentlige lenker til dine OC2-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
OC2 støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger OC2 manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `oc2.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av oc2 i organisasjonen din.
