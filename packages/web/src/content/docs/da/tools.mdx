...
Her er alle de innebygde verktøyene som er tilgængelige i OC2.
...
:::note
Dette verktøyet er bare tilgængelig når `OC2_EXPERIMENTAL_LSP_TOOL=true` (eller `OC2_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger OC2-leverandøren eller når miljøvariabelen `OC2_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
