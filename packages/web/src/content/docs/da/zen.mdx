---
title: Zen
description: Udvalgt liste over modeller leveret af OC2.
---
...
OC2 Zen er en liste over testede og verificerede modeller leveret af OC2-teamet.

Zen fungerer som enhver anden udbyder i OC2. Du logger ind på OC2 Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med OC2.
:::
...
OC2 Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

OC2 Zen fungerer som enhver anden udbyder i OC2.

1. Du logger ind på **<a href={console}>OC2 Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger OC2 Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din OC2-konfiguration
bruger formatet `oc2/<model-id>`. For eksempel ville du for GPT 5.5
bruge `oc2/gpt-5.5` i din konfiguration.
...
- DeepSeek V4 Flash Free er tilgængelig på OC2 i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på OC2 i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på OC2 i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på OC2 i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med OC2 også.
