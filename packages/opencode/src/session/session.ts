...
import type { ProviderMetadata, Usage } from "@oc2-ai/llm"
...
import { PartTable, SessionRootTable, SessionTable } from "@oc2-ai/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@oc2-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".oc2", "plans")
