...
function statusWithFetch(
  ...
  if (providerID !== "openai" && providerID !== "anthropic" && !providerID.startsWith("opencode") && !providerID.startsWith("oc2"))
    return { type: "unsupported", reason: "provider is not openai, oc2, opencode, or anthropic" }
