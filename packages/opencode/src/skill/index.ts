...
import { FrontmatterError } from "@oc2-ai/core/v1/config/error"
...
// Built-in skill that ships with OC2. The model's intuition for what an
// oc2.json should look like is often wrong, and OC2 hard-fails on
