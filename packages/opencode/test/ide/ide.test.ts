...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OC2_CALLER", () => {
    process.env["OC2_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OC2_CALLER", () => {
    process.env["OC2_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OC2_CALLER", () => {
    process.env["OC2_CALLER"] = "unknown"
