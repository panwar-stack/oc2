...
describe("opencode read-only commands (smoke)", () => {
  ...
  // OC2_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh OC2_TEST_HOME means
  ...
  // in production it'd be a path under OC2_TEST_HOME / XDG_DATA_HOME.
