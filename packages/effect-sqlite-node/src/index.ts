...
export const TypeId: TypeId = "~@oc2-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@oc2-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@oc2-ai/effect-sqlite-node/NodeSqliteClient")
