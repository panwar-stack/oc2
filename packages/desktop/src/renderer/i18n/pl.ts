export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji OC2",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} OC2. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'oc2'.",
