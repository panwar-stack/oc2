export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do OC2",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do OC2 foi baixada. Você gostaria de instalá-la e reiniciar?",
