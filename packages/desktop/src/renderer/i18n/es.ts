export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de OC2",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de OC2. ¿Quieres instalarla y reiniciar?",
