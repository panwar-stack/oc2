...
const SIDECAR_SERVICE_NAME = "oc2 server"
...
export function preferAppEnv(userDataPath: string) {
  ...
  Object.assign(process.env, {
    ...
    OC2_EXPERIMENTAL_ICON_DISCOVERY: "true",
    OC2_EXPERIMENTAL_FILEWATCHER: "true",
    OC2_CLIENT: "desktop",
...
export async function checkHealth(url: string, password?: string | null): Promise<boolean> {
  ...
  if (password) {
    const auth = Buffer.from(`oc2:${password}`).toString("base64")
