export const dict = {
  ...
  "dialog.provider.oc2.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.oc2.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.oc2Go.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OC2",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i OC2.",
  ...
  "provider.connect.opencodeZen.line1":
    "OC2 Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i OC2.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i OC2.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i oc2.json",
  ...
  "dialog.server.description": "Skift hvilken OC2-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af OC2 ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OC2-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (oc2.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OC2 understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OC2 inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør OC2-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OC2",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan OC2 ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om OC2 følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan OC2 er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OC2 starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OC2.",
