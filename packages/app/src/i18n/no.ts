...
export const dict = {
  ...
  "dialog.provider.oc2.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.oc2.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.oc2Go.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OC2",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i OC2.",
  ...
  "provider.connect.opencodeZen.line1":
    "OC2 Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OC2.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OC2.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i oc2.json",
  ...
  "dialog.server.description": "Bytt hvilken OC2-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OC2 ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OC2-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (oc2.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OC2 ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "OC2 inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør OC2-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OC2",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OC2 ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om OC2 skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan OC2 er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når OC2 starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OC2.",
