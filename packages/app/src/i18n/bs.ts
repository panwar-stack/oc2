export const dict = {
  ...
  "dialog.provider.oc2.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.oc2.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.oc2Go.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OC2",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OC2-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "OC2 Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OC2-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OC2-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u oc2.json",
  ...
  "dialog.server.description": "Promijeni na koji se OC2 server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija OC2-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OC2 timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (oc2.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OC2 još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OC2 uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni OC2 server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OC2-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako OC2 izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OC2 prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OC2-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OC2 pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OC2-a.",
