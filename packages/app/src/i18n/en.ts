export const dict = {
  ...
  "dialog.model.unpaid.available.title": "Available models",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OC2.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OC2.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OC2.",
  ...
  "prompt.attachment.uploading": "uploading {{name}}…",
  "prompt.action.send": "Send",
  "prompt.action.run": "Run",
  "prompt.action.queue": "Queue",
  "prompt.action.queued": "Queued",
  "prompt.action.stop": "Stop",
  "prompt.state.working": "working",
  "prompt.state.steer": "send steers",
  "prompt.state.queueAnnouncement": "working, your message will be queued",
  "prompt.state.steerAnnouncement": "working, send steers the current turn",
  "prompt.state.shellAnnouncement": "working, the shell command runs immediately",
  "prompt.state.queued": "queued · sends next",
  "prompt.state.queuedPaused": "queued · send when ready",
  "prompt.state.interrupt": "interrupt",
  ...
  "dialog.plugins.empty": "Plugins configured in oc2.json",
  ...
  "dialog.server.description": "Switch which OC2 server this app connects to.",
  ...
  "toast.update.description": "A new version of OC2 ({{version}}) is now available to install.",
  ...
  "error.chain.checkConfig": "Check your config (oc2.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OC2 does not support MCP authentication yet.',
  ...
  "session.decision.waiting": "Waiting on you",
  "session.decision.multiSelect": "Multi-select",
  "session.decision.singleSelect": "Single-select",
  "session.decision.permissionGate": "Permission gate",
  "session.decision.planApproval": "Plan approval",
  "session.decision.move": "Move",
  "session.decision.toggle": "Toggle",
  "session.decision.select": "Select",
  "session.decision.cancel": "Cancel",
  "session.decision.submitting": "Submitting decision",
  "session.decision.questionResolved": "Question resolved — {{count}} selected",
  "session.decision.questionCancelled": "Question cancelled",
  "session.decision.permissionResolved": "Permission resolved — {{decision}}",
  "session.decision.permissionDenied": "Permission denied",
  "session.decision.allowOnceDescription": "Allow only this request",
  "session.decision.allowAlwaysDescription": "Allow matching requests until OC2 restarts",
  "session.decision.denyDescription": "Deny this request",
  ...
  "sidebar.gettingStarted.line1": "Configure credentials for a model provider to get started.",
  "sidebar.gettingStarted.line2": "You can instead configure a local model provider.",
  ...
  "settings.general.row.language.description": "Change the display language for OC2",
  ...
  "settings.general.row.appearance.description": "Customise how OC2 looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OC2 follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OC2 is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OC2 launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OC2.",
