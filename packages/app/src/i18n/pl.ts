export const dict = {
  ...
  "dialog.provider.oc2.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.oc2.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.oc2Go.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OC2",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OC2.",
  ...
  "provider.connect.opencodeZen.line1":
    "OC2 Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OC2.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OC2.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w oc2.json",
  ...
  "dialog.server.description": "Przełącz serwer OC2, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja OC2 ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OC2",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (oc2.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "OC2 zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OC2",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd OC2 na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OC2 ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OC2.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OC2",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OC2.",
