...
export const dict = {
  ...
  "dialog.provider.oc2.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.oc2.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.oc2Go.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "OC2 tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OC2'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "OC2 Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve OC2'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OC2'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler oc2.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OC2 sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "OC2'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı OC2 ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (oc2.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: OC2 henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "OC2 ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.desktop.wsl.description": "OC2 sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "OC2'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "OC2'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OC2'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OC2'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OC2 başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OC2'un en son sürümünü kullanıyorsunuz.",
