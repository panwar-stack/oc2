...
import { Tag } from "@oc2-ai/ui/v2/badge-v2"
...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "opencode", key: "dialog.provider.oc2.note" },
  { match: (id: string) => id === "opencode-go", key: "dialog.provider.oc2Go.tagline" },
