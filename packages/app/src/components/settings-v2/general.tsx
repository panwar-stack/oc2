...
import { SelectV2 } from "@oc2-ai/ui/v2/select-v2"
import { Switch } from "@oc2-ai/ui/v2/switch-v2"
import { TextInputV2 } from "@oc2-ai/ui/v2/text-input-v2"
import { useTheme, type ColorScheme } from "@oc2-ai/ui/theme/context"
      ...
      <SettingsListV2>
        ...
        >
          <div data-action="settings-show-session-progress-bar">
            <Switch
              aria-label={language.t("settings.general.row.showSessionProgressBar.title")}
        ...
        >
          <div data-action="settings-new-layout-designs">
            <Switch
              aria-label={language.t("settings.general.row.newLayoutDesigns.title")}
