import { Component, createMemo, createResource, onMount, type JSX } from "solid-js"
import { Select } from "@oc2-ai/ui/select"
import { Switch } from "@oc2-ai/ui/switch"
        ...
        <SettingsRow
          ...
          description={
            <>
              ...
              <Link href="https://oc2.ai/docs/themes/">{language.t("common.learnMore")}</Link>
            </>
          }
        >
          <Select
