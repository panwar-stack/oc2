import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@oc2-ai/sdk/v2/client"
...
import { List, type ListRef } from "@oc2-ai/ui/list"
...
export function DialogConnectProvider(props: {
  ...
  async function complete() {
    ...
    if (!alive.value || props.isCancelled?.()) return
    dialog.close()
