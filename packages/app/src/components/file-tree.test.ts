...
beforeAll(async () => {
  ...
  mock.module("@oc2-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@oc2-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@oc2-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@oc2-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
