...
import { findLast } from "@oc2-ai/core/util/array"
...
import { File } from "@oc2-ai/ui/file"
import { Markdown } from "@oc2-ai/ui/markdown"
import { ScrollView } from "@oc2-ai/ui/scroll-view"
import type { Message, Part, UserMessage } from "@oc2-ai/sdk/v2/client"
...
export function SessionContextTab() {
  ...
  const stats = [
    ...
    { label: "context.stats.totalTokens", value: () => formatter().number(getSessionTokenTotal(info()?.tokens)) },
