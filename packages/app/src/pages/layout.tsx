...
import { ResizeHandle } from "@oc2-ai/ui/resize-handle"
...
import { Session, type Message } from "@oc2-ai/sdk/v2/client"
...
import { toaster } from "@oc2-ai/ui/toast"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://github.com/panwar-stack/oc2#readme")}
      renderPanel={() =>
