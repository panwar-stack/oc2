...
export function SessionWorkingBar(props: {
  ...
  let previous = { sessionID: props.sessionID, working: props.working }
  createEffect(() => {
    const sessionID = props.sessionID
    const working = props.working
    const blocked = props.blocked
    if (working || previous.sessionID !== sessionID) setAnnouncement("")
    if (previous.sessionID === sessionID && previous.working && !working && !blocked) setAnnouncement("Turn completed")
    previous = { sessionID, working }
  })
  onMount(() => {
