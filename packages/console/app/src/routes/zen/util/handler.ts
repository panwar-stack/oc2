...
import { and, Database, eq, isNull, lt, or, sql } from "@oc2-ai/console-core/drizzle/index.js"
import { KeyTable } from "@oc2-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@oc2-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@oc2-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@oc2-ai/console-core/util/date.js"
import { Identifier } from "@oc2-ai/console-core/identifier.js"
import { Billing } from "@oc2-ai/console-core/billing.js"
import { Actor } from "@oc2-ai/console-core/actor.js"
import { WorkspaceTable } from "@oc2-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@oc2-ai/console-core/model.js"
import { Subscription } from "@oc2-ai/console-core/subscription.js"
import { BlackData } from "@oc2-ai/console-core/black.js"
import { UserTable } from "@oc2-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@oc2-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@oc2-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@oc2-ai/console-core/lite.js"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-oc2-session") ?? ""
    const requestId = input.request.headers.get("x-oc2-request") ?? ""
    const ocClient = input.request.headers.get("x-oc2-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-oc2-request")
          headers.delete("x-oc2-session")
          headers.delete("x-oc2-project")
          headers.delete("x-oc2-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://oc2.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://oc2.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://oc2.ai/workspace/${authInfo.workspaceID}/members`
