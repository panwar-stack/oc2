...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>OC2 | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="OC2 terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to OC2. Please read on to learn the rules and restrictions that govern your use of
                OC2&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("OC2," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://oc2.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-oc2">What is OC2?</h2>
              <p>
                OC2 is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the OC2 Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, OC2 enables you to
              ...
              <p>
                ...
                our site located at oc2.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                OC2 takes the privacy of its users very seriously. For the current OC2 Privacy Policy, please
                click here{" "}
                <a href="https://oc2.ai/legal/privacy-policy">https://oc2.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using OC2?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by OC2;
                </li>
                <li>
              ...
              <p>
                If you use OC2 with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                OC2. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                OC2 has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-oc2-ever-change-the-services">Will OC2 ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://oc2.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://oc2.ai/auth">https://oc2.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://oc2.ai/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                OC2 is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. OC2 has the sole right to decide whether you are
              ...
              <p>
                OC2 and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (OC2 and all such
                parties together, the "OC2 Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the OC2 Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The OC2 Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY OC2 (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                OC2 PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO OC2 IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the OC2 Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without OC2's prior written
              ...
              <p>
                ...
                disputes and claims with OC2 and limits the manner in which you can seek relief from OC2. Both
                you and OC2 acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, OC2's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. OC2 will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. OC2 will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or OC2 may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND OC2 WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and OC2 are instead choosing to have claims and disputes resolved by
                ...
                you and OC2 over whether to vacate or enforce an arbitration award, YOU AND OC2 WAIVE ALL
              ...
              <p>
                ...
                OC2 is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or OC2 to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and OC2 agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the OC2 may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and OC2 agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and OC2, and
                ...
                are not an employee, agent, partner, or joint venture of OC2, and you do not have any authority of
                any kind to bind OC2 in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and OC2
