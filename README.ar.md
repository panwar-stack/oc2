...
# مديري الحزم
npm i -g oc2@latest        # او bun/pnpm/yarn
...
يتوفر OC2 ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/anomalyco/opencode/releases) او من [oc2.ai/download](https://oc2.ai/download).
