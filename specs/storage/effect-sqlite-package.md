...
1. Add `@oc2-ai/effect-drizzle-sqlite` with a minimal in-memory/file SQLite test schema.
...
4. Add `@oc2-ai/effect-drizzle-sqlite` as a dependency of `packages/opencode`.
