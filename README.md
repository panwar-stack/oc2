...
OC2 is also available as a desktop application. Download directly from the [releases page](https://github.com/panwar-stack/oc2/releases) or [oc2.ai/download](https://oc2.ai/download).
