...
# 软件包管理器
npm i -g oc2@latest        # 也可使用 bun/pnpm/yarn
scoop install oc2             # Windows
choco install oc2             # Windows
brew install anomalyco/tap/oc2 # macOS 和 Linux（推荐，始终保持最新）
brew install oc2              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S oc2            # Arch Linux (Stable)
paru -S oc2-bin               # Arch Linux (Latest from AUR)
mise use -g oc2               # 任意系统
nix run nixpkgs#oc2           # 或用 github:anomalyco/opencode 获取最新 dev 分支
```
...
1. `$OC2_INSTALL_DIR` - 自定义安装目录
2. `$XDG_BIN_DIR` - 符合 XDG 基础目录规范的路径
3. `$HOME/bin` - 如果存在或可创建的用户二进制目录
4. `$HOME/.oc2/bin` - 默认备用路径
...
了解更多 [Agents](https://oc2.ai/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://oc2.ai/docs)。
...
如果你在项目名中使用了 “oc2”（如 “oc2-dashboard” 或 “oc2-mobile”），请在 README 里注明该项目不是 OC2 团队官方开发，且不存在隶属关系。
