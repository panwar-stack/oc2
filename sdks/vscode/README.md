# OC2 VS Code Extension

A Visual Studio Code extension that integrates [OC2](https://oc2.ai) directly into your development workflow.

## Prerequisites

This extension requires the [oc2 CLI](https://oc2.ai) to be installed on your system. Visit [oc2.ai](https://oc2.ai) for installation instructions.
